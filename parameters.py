...
#data_folders_list = ['udacity/', 'Smooth_driving2/', 'Recovering_from_left3/']
#data_folders_list = ['udacity/', 'Recovering_from_left3/']
...
urls_list = ['https://d17h27t6h515a5.cloudfront.net/topher/2016/December/584f6edd_data/data.zip',
             ...
             'https://s3-us-west-2.amazonaws.com/carnd-rs/Recovering_from_left3.zip']
